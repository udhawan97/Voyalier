...
Live fetches — official advice, weather, and pack downloads — happen only on an explicit click, and each is labeled with its source, retrieval time, license, and freshness.
