  ...
  try {
    ...
    await writeFile(
      ...
      [
        ...
        `- Portable backup target: exact returned-path notice plus atomic new file (${portableBackupStat.size} bytes, SHA-256 ${portableBackupSha256})`,
        `- Portable restore target: candidate guard passed before matching pre-read hash and staging`,
