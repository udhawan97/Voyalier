 ...
 * - `` `concierge:${id}` `` — one trip's concierge projection
...
/** One trip's local concierge profile, wallet, costs and deterministic projection. */
export const conciergeScope = (tripId: string): Scope => `concierge:${tripId}`;
