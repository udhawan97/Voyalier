...
const ARGS: Record<keyof AppGateway, unknown[]> = {
  ...
  saveTripIntent: [{}],
  listTripIntents: [],
  deleteTripIntent: ["intent_1"],
  convertTripIntent: [{ draftId: "intent_1" }],
  getTrip: ["trip_1"],
  getConciergeWorkspace: ["trip_1"],
  setConciergeProfile: [{ tripId: "trip_1" }],
  updateTrip: ["trip_1", {}],
  archiveTrip: ["trip_1"],
  ...
  importAttachment: [{ tripId: "trip_1" }],
  listAttachments: ["trip_1"],
  getAttachment: ["attachment_1"],
  deleteAttachment: ["attachment_1"],
  getTripNotes: ["trip_1"],
