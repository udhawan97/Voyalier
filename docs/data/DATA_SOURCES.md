...
| Diplomatic missions | Wikidata diplomatic-mission SPARQL extract (`P137` sender, `P17` host) | CC0 (Wikidata)                                                     | ~9,800 embassies, consulates-general, consulates and high commissions bundled with coordinates. **A pointer, not an address**: closure is recorded unevenly (the raw extract still returned embassies of states dissolved in 1990), honorary consulates are excluded, and the city is sometimes the ward rather than the city. Always rendered beside "confirm with your own foreign ministry" |
| Eclipses            | NASA GSFC five-millennium eclipse catalogues                           | US Government public domain                                        | 31 solar and lunar eclipses 2026-2032 transcribed and cross-checked against the decade tables. Carries NASA's required credit line. The visibility band is NASA's own coarse region, never a local-circumstances calculation for the destination                                                                                                                                               |
