...
| Sensitive cloud disclosure                    | Cloud mode not implemented                | Consent preview, field redaction, provider retention copy          |
| Unsafe sharing                                | Sharing not implemented                   | Audience profiles, redaction preview, expiring/encrypted formats   |
