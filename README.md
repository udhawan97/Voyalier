...
| **Packing**          | Derive suggestions only from trip/weather evidence, then let the traveler explicitly accept or ignore each one alongside custom persistent checklist items                                                                                                                                         |
