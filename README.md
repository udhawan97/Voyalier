...
| **Visa preparation**  | Quote a destination's published entry path with its source and the date it was read; walk a curated route step by step with plain-language explanations, per-document cautions, and official links; persist ticks and sealed notes per trip. Canada and Japan are curated; nothing is ever asserted |
...
- **More sourced readiness** — only where licensing, retrieval, and authority boundaries stay honest. (Visa preparation covers Canada and Japan: pointers and plain-language steps, never determinations. More destinations are curation work.)
